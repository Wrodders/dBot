...
static IMU imuInit(float alphaAccel, float alphaGyro, float alphaComp, float dt){
    IMU imu = {
        .dt = dt,
...
static float imuKalPredict(Kalman *kal, float newAngle, float newRate, float dt) {
