...
% Note that if/when you edit these you may need to 'Recompile from scratch' to get the changes to display in the PDF. (In Overleaf, select the down arrow to the right of the 'Recompile' button)
  ...
  %%%%%%%%%%%%%%%%%% SECTION 1 %%%%%%%%%%%%%%%%%%
    ...
    This paper is split in 2 parts, the first part focuses on the design of the TWSB system, the second part
  ...
  %%%%%%%%%%%%%%%%%% SECTION 2 %%%%%%%%%%%%%%%%%%
    ...
    \section{Control System}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.4\textwidth, height=0.2\textheight]{Diagrams/PurePersuit.pdf}
