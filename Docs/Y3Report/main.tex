...
\begin{filecontents*}{\jobname.xmpdata}
  ...
  \section{Methodology } % edit section heading as appropriate
    \subsection{System Design and Modeling}
        ...
        \subsection{{BOM and Cost Analysis}}
    \subsection{State Space Model}
        \subsubsection{2D Kinematics}
        \subsubsection{3D Dynamics}
        \subsubsection{DC Motor Model}
        \subsubsection{Parameter Estimation}
    \subsection{Software Architecture}
        \subsubsection{Compute Systems Overview }
        \subsubsection{Test Bench Programs}
    ...
    \subsection{Vision System}
        ...
        adding the curvature K, 
            ...
            \subsubsection{IMU Based Software Stabilization}
